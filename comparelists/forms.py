...
class compare_lists_input_form(forms.Form):
    ...
    resultFoundInList2 = forms.CharField(label='', widget=forms.Textarea(attrs={'class':'compare-lists-input'}))
    resultMissingInList2 = forms.CharField(label='', widget=forms.Textarea(attrs={'class':'compare-lists-input'}))
